...
SECRET_KEY = 'django-insecure-k95@8uhp+$+12m$b00npx$8k-0^4l9_%)a3ns5em%=(sb9i$u#'
...
# para acessar de todos locais as funcoes da api
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'django_errors.log',  # Arquivo onde os logs de erro serão armazenados
        },
    },
    'loggers': {
        'django': {
